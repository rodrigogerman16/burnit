...
<nav className="px-4 sm:px-4 py-2.5 w-full top-0 left-0">
  ...
  <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
    <ul className="flex flex-col p-4 mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
      <li>
        <a href="#" className="block py-2 pl-3 pr-4 text-white hover:text-lime-400 md:bg-transparent md:p-0" aria-current="page">Home</a>
      </li>
      <li>
        <a href="#" className="block py-2 pl-3 pr-4 text-white hover:text-lime-400 md:bg-transparent md:p-0">Workouts</a>
      </li>
      <li>
        <a href="#" className="block py-2 pl-3 pr-4 text-white hover:text-lime-400 md:bg-transparent md:p-0">Pricing</a>
      </li>
      <li>
        <a href="#" className="block py-2 pl-3 pr-4 text-white hover:text-lime-400 md:bg-transparent md:p-0">Contact</a>
      </li>
    </ul>
  </div>
  </div>
